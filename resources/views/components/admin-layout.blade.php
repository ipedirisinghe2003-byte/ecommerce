    ...
    <div class="min-h-screen flex flex-col">
        <header class="bg-white border-b border-gray-200 h-20 flex items-center justify-between px-4 lg:px-6">
            <div class="flex items-center gap-3 min-w-[180px]">
                <div class="w-10 h-10 rounded-md bg-gradient-to-br from-sky-600 to-sky-800 text-white flex items-center justify-center text-xl font-bold shadow-sm">L</div>
                <span class="text-2xl font-bold tracking-wide text-gray-800">Logo</span>
            </div>
